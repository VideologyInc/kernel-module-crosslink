...
LVDS_CMD_GET_UART_RX_FILLRATE = 0x7612
LVDS_CMD_GET_UART_FULL        = 0x7613
LVDS_CMD_SET_FORMAT_PAL     = 0x7614
LVDS_CMD_SET_FORMAT_NTSC    = 0x7615
LVDS_CMD_GET_VIDEOFORMAT    = 0x7616
LVDS_CMD_GET_FPGA_PERIOD    = 0x7617
